...
import com.spring.restaurant.domain.AjaxWriteList;
import com.spring.restaurant.domain.AjaxWriteResult;
import com.spring.restaurant.domain.WriteDTO;
import com.spring.restaurant.service.AjaxService;
...
public class AjaxController {
	...
	public AjaxWriteList view(@PathVariable int uid) {
		...
		try {
			list = ajaxService.readByUid(uid);  // 조회수 증가 + 읽기
